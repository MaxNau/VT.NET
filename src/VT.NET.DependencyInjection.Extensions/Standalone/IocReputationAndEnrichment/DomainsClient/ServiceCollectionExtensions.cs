...
namespace VT.NET.DependencyInjection.Extensions.Standalone.IocReputationAndEnrichment.DomainsClient
{
    public static class ServiceCollectionExtensions
    {
            ...
            int pooledConnectionLifetimeInMinutes = 2)
        {
            ...
            return VTClientRegistrationFactory.Register(services, apiKey, apiUrl, pooledConnectionLifetimeInMinutes, vtClients: VTClients.Domains);
        }
           ...
           int pooledConnectionLifetimeInMinutes = 2)
        {
            ...
            return VTClientRegistrationFactory.Register(services, configuration: configuration, pooledConnectionLifetimeInMinutes: pooledConnectionLifetimeInMinutes, vtClients: VTClients.Domains);
        }
    }
}
