...
namespace VT.NET.DependencyInjection.Extensions.Standalone.IocReputationAndEnrichment.FilesClient
{
    public static class ServiceCollectionExtensions
    {
            ...
            int pooledConnectionLifetimeInMinutes = 2)
        {
            ...
            return VTClientRegistrationFactory.Register(services, apiKey, apiUrl, pooledConnectionLifetimeInMinutes, vtClients: VTClients.Files);
        }
           ...
           int pooledConnectionLifetimeInMinutes = 2)
        {
            ...
            return VTClientRegistrationFactory.Register(services, configuration: configuration, pooledConnectionLifetimeInMinutes: pooledConnectionLifetimeInMinutes, vtClients: VTClients.Files);
        }
    }
}
